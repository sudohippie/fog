...
def test_abspath_empty():
    eq_(abs_path(None), None)
    eq_(abs_path(''), None)


def test_abspath_absolute():
...
def test_split_invalid_slash_count():
...
def test_filename_file():
    ...
    for p in path:
        ...
        # filename, in=ends with slash
def test_filename_folder():
